...
aligns the extracted regions and also outputs a unaligned file. The aligned file is
directly visualized in the terminal using the embedded approach for quick view
just like the samtools viewer.
